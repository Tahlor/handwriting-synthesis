...
#SBATCH --output="/panfs/pan.fsl.byu.edu/scr/grp/fslg_hwr/handwriting-synthesis/checkpoints/no_pretrain_v1/log_train_synth.slurm"
...
python -u rnn.py --warm_start 0 --checkpoint_folder "/panfs/pan.fsl.byu.edu/scr/grp/fslg_hwr/handwriting-synthesis/checkpoints/no_pretrain_v1"
